                ...
                <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
                    <div
                        ...
                        <div class="sw-lg-50 px-5">
                            ...
                            <div>
                                <form id="registerForm" class="tooltip-end-bottom" novalidate="novalidate">
                                    <div class="mb-3 filled form-group tooltip-end-top">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="acorn-icons acorn-icons-user undefined">
                                            <path
                                    ...
                                    <div class="mb-3 filled form-group tooltip-end-top">
                                        ...
                                        <input class="form-control" name="registerPassword" type="password"
